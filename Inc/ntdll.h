...
// description: 
//  Constants, macros, structures and functions used by native NT executables.
...
typedef struct _LDR_DATA_TABLE_ENTRY_WIN6
{
	LIST_ENTRY		InLoadOrderModuleList;
    LIST_ENTRY		InMemoryOrderModuleList;
    LIST_ENTRY		InInitializationOrderModuleList;
	...
	LIST_ENTRY		ServiceTagLinks;
	LIST_ENTRY		StaticLinks;
} LDR_DATA_TABLE_ENTRY_WIN6, *PLDR_DATA_TABLE_ENTRY_WIN6;

typedef union _LDR_DATA_TABLE_ENTRY_EX
{
	LDR_DATA_TABLE_ENTRY LdrEntry;
	LDR_DATA_TABLE_ENTRY_WIN6	Win6;	// i.e Vista
	LDR_DATA_TABLE_ENTRY_WIN7	Win7;
	LDR_DATA_TABLE_ENTRY_WIN8	Win8;
